...
export class MedicalHistoryService {
  ...
  getAll() {
    return this.httpClient.get<MedicalHistoryDTO[]>(`${environment.baseUrl}/api/medicalhistory`, this.options).pipe(
  ...
  addMedicalHistory(medicalHistoryDTO: CreateMedicalHistoryDTO) {
    return this.httpClient.post(`${environment.baseUrl}/api/medicalhistory`, medicalHistoryDTO, this.options).pipe(
      catchError((err, caught) => {
        console.log(err);
        this.handleErrors(err);
        return of();
  ...
  deleteRecord(recordId: number) {
    return this.httpClient.delete(`${environment.baseUrl}/api/medicalhistory/${recordId}`, this.options).pipe(
      catchError((err, caught) => {
        console.log(err);
        this.handleErrors(err);
        return of();
  ...
  updateRecord(medicalHistory: UpdateMedicalHistoryDTO){
    return this.httpClient.put(`${environment.baseUrl}/api/medicalhistory/${medicalHistory.medicalHistoryID}`, medicalHistory, this.options).pipe(
      catchError((err, caught) => {
        console.log(err);
        this.handleErrors(err);
        return of();
